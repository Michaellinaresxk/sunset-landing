...
import UrgencySection from '@/src/components/sections/UrgencySection';
...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: 'Book Your Horseback Riding — Punta Cana',
    description:
      'From $65/person · Hotel pickup included · Free cancellation 24h',
