...
import WhatsAppConfirmModal from '@/src/components/WhatsAppConfirmModal';

const WHATSAPP_FOOTER_URL = 'https://wa.me/18298123753';
        ...
        <div className='max-w-3xl mx-auto px-4 py-12'>
          <div className='grid grid-cols-1 md:grid-cols-[1fr_auto] gap-10 items-start'>
            ...
            <div className='space-y-3'>
              ...
              {/* WhatsApp — now opens confirmation modal */}
              <button
                onClick={() => setShowModal(true)}
                className='flex items-center gap-3 text-white/60 hover:text-white transition-colors group w-full text-left'
