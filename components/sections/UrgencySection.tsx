...
import { CONTACT_EMAIL, CONTACT_SUBJECT, CONTACT_BODY } from '@/constants';
          ...
          <div className='max-w-5xl mx-auto px-4 md:px-8 text-center relative z-10'>
            <div className={`transition-all duration-1000 ${isVisible ? 'opacity-100 scale-100' : 'opacity-0 scale-95'}`}>
              <div className='inline-flex items-center gap-2 px-5 py-2 rounded-full bg-amber-500/10 border border-amber-500/20 mb-6'>
                ...
                <span className='text-amber-300 text-sm font-light tracking-wider uppercase'>Personal Support</span>
              </div>

              <h3 className='text-3xl md:text-5xl font-light text-white mb-4'>Need Booking Assistance?</h3>
              <p className='text-white/60 font-light mb-8 text-base md:text-lg'>
                Email us directly—we&apos;ll contact you and help plan your perfect sunset ride.
              </p>
